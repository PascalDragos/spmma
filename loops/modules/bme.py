"""BME280 Driver based on Pimoroni implementation"""
from i2cdevice import Device, Register, BitField, _int_to_bytes
from i2cdevice.adapter import LookupAdapter, Adapter
from smbus import SMBus  # biblioteca pentru i2c
import struct
import time
...
class BME280Calibration():
    ...
    # Presiunea ambientala in functie de temperatura interna a senzorului
    ...
    # Umiditatea relativa (%) in functie de temperatura interna a senzorului
...
class BME280:
    def __init__(self, i2c_addr=I2C_ADDRESS_GND):
        ...
        i2c_bus = SMBus(1)
        self.__calibration = BME280Calibration()
        self.__is_setup = False
        self.__i2c_addr = i2c_addr
        self.__i2c_dev = i2c_bus
        self.__bme280 = Device([I2C_ADDRESS_GND, I2C_ADDRESS_VCC], i2c_dev=self.__i2c_dev, bit_width=8, registers=(
    ...
    def setup(self, mode='normal', temperature_oversampling=16, pressure_oversampling=16, humidity_oversampling=16,
        ...
        self.__bme280.set('RESET', reset=0xB6)
        time.sleep(0.1)
    ...
    def read_parameters(self):
        if self.__mode == "forced":
            # Genereaza o citire
            self.__bme280.set('CTRL_MEAS', mode="forced")
